...
function updateLinkState() {
    ...
    const alertTexts = {
        ...
        ja: "セルをクリックし、リフター（チーンタイプ）で サイクルタイム を確認してください"
    };
    const accesspages = {
        zh: "../pages/liftcv.html",
        en: "../pages/liftcv.html",
        ja: "../pages/liftcv.html"
    };
    const alertTexts2 = {
        zh: "点击单元格并在LIFT RAIL中确认升降机循环时间",
        en: "Press the cell and confirm Lifter's Cycle time in LIFT RAIL",
        ja: "セルをクリックし、リフタ（レ一ルタイプ）で サイクルタイム を確認してください"
    }
    const accesspages2 = {
        zh: "../pages/liftrail.html",
        en: "../pages/liftrail.html",
        ja: "../pages/liftrail.html"
    }
